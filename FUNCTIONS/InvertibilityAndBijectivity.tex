...
up a new theory called ZFC (ZFC + AC axiom of choice). For now, we will not use these theorems and we will just 
claim that every bijection is invertible using the definition of bijectivity (lemma \ref{lem:inverseOfBijection}). We will soon 
introduce a new axiom which implies AC and then we will be able to use these results. \\