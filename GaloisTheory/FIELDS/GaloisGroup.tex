...
\begin{theorem}[Fundamental theorem of Galois theory]
    ...
    $$ \mathcal{G}(I) = Gal_{I}(F)  $$
\end{theorem}
\begin{proof}
    The function $\Phi$ is clearly injective, so we only need to show that it's surjective. To 
    ...
    automorphism in $H$. We will show that $I$ is in the domain of $\Phi$ such that
    $\Phi(I) = H$ by its very construction. \\
