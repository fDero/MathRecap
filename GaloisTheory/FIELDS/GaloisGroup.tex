...
\begin{theorem}
    ...
    given that $A \subseteq B \subseteq S$ ($B$ subfield of $A$, $S$ field extension of $A$).
\end{theorem}
\begin{proof}
    ...
    an automorphism that is still fixing $A$ but restricted to $B$. The function is clearly 
    surjective, since every element of $Gal_{A}(B)$ reached by itself, anyway it's not important,
    we just need to show that is a well-defined automorphism, to be able to inspect it's kernel: \\
...
\vspace{6em}
On many books and online resources, this theorem is stated as a corollary or even as a part 
of the fundamental theorem of Galois theory, but I think it's important to state it separately, 
since it depends from the first theorem of isomorphism. By stating it separately, we are 
decoupling the fundamental theorem of Galois theory from the theorems of isomorphisms, herby
making it possible for the reader to reed the proof of the fundamental theorem of Galois theory 
without having a profound knowledge of group theory. Thus the reader might jump over this proof 
entirely and still have a grasp of what's going on in a more general sense. \\
